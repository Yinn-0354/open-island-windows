...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["Settings_Glass"] = "液态玻璃",
        ["Settings_Glass_Desc"] = "调整灵动岛切到「液态玻璃」背景样式时的观感：模糊强度、饱和度、折射/色散强度。改动立即生效并持久化。",
        ["Settings_Glass_Blur"] = "模糊强度",
        ["Settings_Glass_Saturation"] = "饱和度",
        ["Settings_Glass_Refraction"] = "折射强度",
        ...
        ["Island_CheckUpdate_Tip"] = "检查更新：从 GitHub 拉取最新版本",
        ["Update_Title"] = "发现新版本 v{0}",
        ["Update_Install"] = "立即更新",
        ["Update_Later"] = "稍后",
        ["Update_Checking"] = "检查中…",
        ["Update_UpToDate"] = "已是最新 v{0}",
        ["Update_CheckFailed"] = "检查失败，请稍后重试",
        ["Update_Downloading"] = "下载中 {0}%",
        ["Update_DownloadFailed"] = "下载失败，请稍后重试",
        ...
        ["Reply_SessionNavFailed"] = "没能切到目标会话，已取消（避免发错）",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Settings_Glass"] = "Liquid Glass",
        ["Settings_Glass_Desc"] = "Tune how the island looks in Liquid Glass background style: blur strength, saturation, refraction/aberration strength. Changes apply instantly and persist.",
        ["Settings_Glass_Blur"] = "Blur",
        ["Settings_Glass_Saturation"] = "Saturation",
        ["Settings_Glass_Refraction"] = "Refraction",
        ...
        ["Island_CheckUpdate_Tip"] = "Check for updates from GitHub",
        ["Update_Title"] = "New version v{0} available",
        ["Update_Install"] = "Update now",
        ["Update_Later"] = "Later",
        ["Update_Checking"] = "Checking…",
        ["Update_UpToDate"] = "Up to date (v{0})",
        ["Update_CheckFailed"] = "Check failed, try again later",
        ["Update_Downloading"] = "Downloading {0}%",
        ["Update_DownloadFailed"] = "Download failed, try again later",
        ...
        ["Reply_SessionNavFailed"] = "Couldn't switch to the target conversation; canceled to avoid wrong send",
